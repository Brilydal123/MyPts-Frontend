        ...
        <Card className="overflow-hidden bg-white dark:bg-black border-0 shadow-sm rounded-xl">
          <CardHeader className="border-b border-neutral-100 dark:border-neutral-800 px-8 py-6">
            <div className="flex items-center justify-between">
              <div>
                <CardTitle className="text-xl font-semibold text-black dark:text-white tracking-tight">
                  MyPts Tokenomics
                </CardTitle>
              ...
              >
                <PieChart className="h-5 w-5 text-white dark:text-black" />
              </motion.div>
            </div>
          </CardHeader>
          <CardContent className="p-8">
            {isLoading ? (
              <div className="space-y-6">
                <div className="h-48 w-48 bg-neutral-100 dark:bg-neutral-800 rounded-full animate-pulse mx-auto"></div>
                <div className="h-12 bg-neutral-100 dark:bg-neutral-800 rounded-md animate-pulse"></div>
              </div>
            ) : (
              <motion.div
              ...
              >
                  ...
                  <div className="relative w-64 h-64">
                    ...
                    >
                      ...
                      <motion.circle
                        ...
                        strokeWidth="20"
                        strokeDasharray={`${circulatingPercentage * 2.51} ${
                          (100 - circulatingPercentage) * 2.51
                        }`}
                        strokeLinecap="round"
                      ...
                      <motion.circle
                        ...
                        stroke="#000000" // black
                        strokeWidth="20"
                        strokeDasharray={`${holdingPercentage * 2.51} ${
                          (100 - holdingPercentage) * 2.51
                        }`}
                ...
                >
                  <div className="bg-neutral-50 dark:bg-neutral-900 p-6 rounded-xl border border-neutral-100 dark:border-neutral-800 transition-all duration-200 hover:shadow-md">
                    ...
                    <div className="mt-4 pt-4 border-t border-neutral-100 dark:border-neutral-800">
                      <p className="text-sm text-neutral-500 dark:text-neutral-400 flex items-center">
                        <ArrowUpRight className="h-3.5 w-3.5 mr-1 text-neutral-400" />
                        {formatCurrency(
                  ...
                  <div className="bg-neutral-50 dark:bg-neutral-900 p-6 rounded-xl border border-neutral-100 dark:border-neutral-800 transition-all duration-200 hover:shadow-md">
                    ...
                    <div className="mt-4 pt-4 border-t border-neutral-100 dark:border-neutral-800">
                      <p className="text-sm text-neutral-500 dark:text-neutral-400 flex items-center">
                        <ArrowDownRight className="h-3.5 w-3.5 mr-1 text-neutral-400" />
                        {formatCurrency(
                ...
                <motion.div
                  variants={itemVariants}
                  className="bg-black dark:bg-white p-6 rounded-xl text-white dark:text-black"
                >
                  <div className="flex items-center justify-between">
                    <div>
                      <h3 className="font-medium text-neutral-300 dark:text-neutral-700 text-sm">
                        Total Value
                      </h3>
