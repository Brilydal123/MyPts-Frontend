...
export const RegistrationFlow = () => {
  ...
  const steps = [
    ...
    { title: 'Get Started', component: BasicInfoStep, showInProgress: true, stepNumber: 1 },
    { title: 'Eligibility', component: EligibilityStep, showInProgress: true, stepNumber: 2 },
    { title: 'Set Up', component: SetupStep, showInProgress: true, stepNumber: 3 },
    { title: 'Secure', component: SecureStep, showInProgress: true, stepNumber: 4 },
  ...
  const CurrentStepComponent = steps[currentStep]?.component || EmailRegistrationStep;

  return (
    <div className="p-6 flex flex-col" style={{ minHeight: 'calc(100vh - 300px)' }}>
