...
export function UsernameSuggestions({
  ...
  console.log('UsernameSuggestions component:', { suggestions, isLoading });
  ...
  if (isLoading) {
    return (
      <motion.div
        ...
        className="absolute top-full left-0 right-0 mt-4 mx-auto max-w-md p-6 backdrop-blur-md bg-white/70 dark:bg-gray-900/70 rounded-xl border border-gray-200/50 dark:border-gray-700/50 shadow-xl z-50"
        style={{
