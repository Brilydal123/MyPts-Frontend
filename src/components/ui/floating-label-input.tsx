...
>(({ label, error, className, containerClassName, icon, ...props }, ref) => {
  ...
  return (
    <div
      className={cn(
        "relative  max-w-md mx-auto w-full max-sm:max-w-full",
        containerClassName
      )}
    >
      <div></div>
      <div className="relative">
        {icon && (
          <div
            className=" max-w-md mx-autobg-gray-100 h-full w-[2.5rem] absolute
            rounded-l-md
            "
          >
        ...
        <Input
          ...
          {...props}
          className={cn(
            "h-10 pb-2 transition-all duration-300 border-2",
        ...
        <span
          ...
          style={{
            transitionProperty:
              "top, font-size, transform, background-color, color",
          }}
        >
          {label}
        </span>
