...
export function ReferralStatsCard({
  ...
  return (
    <motion.div
      className="relative bg-white dark:bg-[#1C1C1E] rounded-2xl p-6 h-full border border-[#E5E5EA] dark:border-[#38383A] shadow-[0_2px_8px_rgba(0,0,0,0.04)] dark:shadow-[0_2px_8px_rgba(0,0,0,0.15)] backdrop-blur-sm overflow-hidden"
      whileHover={{
        y: -2,
