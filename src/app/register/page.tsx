    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-200 p-4 auth-container auth-bg-pattern">
      ...
      <div className="w-full max-w-[1200px] flex relative z-10">
        ...
        <div className="hidden md:flex md:w-1/2 relative">
          <div className="absolute inset-0 rounded-l-3xl overflow-hidden shadow-2xl bg-[#c4c4c4]">
            {/* Background elements */}
            ...
            <div className="absolute left-1/4 top-1/4 transform -translate-x-1/2 -translate-y-1/2 w-40 h-40 bg-blue-300/50 rounded-full blur-xl"></div>
            <div className="absolute right-1/4 bottom-1/4 transform translate-x-1/2 translate-y-1/2 w-40 h-40 bg-pink-200/50 rounded-full blur-xl"></div>
            {/* <div className="absolute right-2/4 top-1/4 bottom-1/4 transform translate-x-1/2 translate-y-3/2 w-40 h-60 bg-slate-600/50 rounded-full blur-xl"></div> */}
            {/* Subtle grid pattern */}
        ...
        <div className="w-full md:w-1/2 bg-white rounded-3xl md:rounded-l-none md:rounded-r-3xl shadow-2xl overflow-hidden relative">
          ...
          {/* Bottom decoration */}
          <div className="absolute bottom-0  h-4 bg-gradient-to-r from-blue-500 via-pink-500 to-purple-500"></div>
        </div>
      </div>
    </div>
  );
